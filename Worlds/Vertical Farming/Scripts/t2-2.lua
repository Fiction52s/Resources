...
function UpdatePostPhysics()
	...
	--end
	if a_elevator1:GetVelocity().y ~= 0 and player:GetPosition().y < a_elevator1:GetPosition().y and 
		math.abs( player:GetPosition().x - a_elevator1:GetPosition().x ) < 11.5  then
		stage:SetCameraPosition( a_elevator1:GetPosition().x, a_elevator1:GetPosition().y - 10 )
	end
