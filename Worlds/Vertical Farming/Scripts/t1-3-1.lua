...
zoomGoal = 1
	...
	--print( "vel: " .. player:GetVelocity().x )
	...
	if zoomGoal < zoom and not zoomedOut then
	--	print( "zoom in" )
		slowCounter = slowCounter + 1
		if slowCounter > 5 then
	...
	--zoom = 1
	--print( "zoomgoal: " .. zoomGoal )
	stage:SetCameraZoom( zoom )
	--print( "zooooom: " .. zoom )
	maxoffsetx = 8 * zoom
	maxoffsety = 5 * zoom
	--print( "prevel: " .. player:GetVelocity().x )
end

function UpdatePostPhysics()
	
	--print( "normal vel: " .. player:GetVelocity().x )
	
	--print( "true vel: " .. (player:GetPosition().x - oldX) * 60 )
	oldX = player:GetPosition().x
	--print( "true vel: " ..  fff )
	--oldX = oldX
	--print(  player:GetPosition().x - oldX )
	--test = player:GetPosition().x - old.x
	...
	--if camx < 16 * zoom then camx = 16 * zoom end
